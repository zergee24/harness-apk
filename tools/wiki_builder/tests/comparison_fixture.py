"""Generate a second signed Wiki fixture for Android comparison-flow tests."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="生成双 Wiki 比较测试 fixture")
...
def main(argv: list[str] | None = None) -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="harness-hwiki-comparison-fixture-") as temp:
        root = Path(temp)
