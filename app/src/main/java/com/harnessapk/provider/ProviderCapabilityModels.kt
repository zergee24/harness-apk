                ...
                ?.let { config ->
                    CatalogResolution(
                        capability = ModelCapability(
                            ...
                            inputModalities = config.inputModalities ?: listOf("text"),
                            outputModalities = config.outputModalities ?: listOf("text"),
                            reasoningEffortOptions = config.reasoningEffortOptions ?: emptyList(),
                            defaultReasoningEffort = config.defaultReasoningEffort,
                            webSearchMode = config.webSearchMode ?: NativeWebSearchMode.DISABLED,
